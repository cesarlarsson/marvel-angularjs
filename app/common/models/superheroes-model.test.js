describe('marvel.models.superheroes module', function() {
    
      beforeEach(module('marvel.models.superheroes'));
      ...
      describe('SuperHeroesModel service', function(){
            ...
            beforeEach(inject(function($injector) {
                  service = $injector.get('SuperHeroesModel');
                  httpBackend = $injector.get('$httpBackend');

            }));
            
           /*  var idhero=1; var limit=1; var offset=3
            it('getTypes - should return 4 car manufacturers', function () {

                  httpBackend.expectGET(urls.characters).respond(
                  {
                        weather: [{main : 'Rain', detail : 'Light rain'}],
                        main : { temp : 288 }
                  }
                  );
                  service.getCharacterTest(idhero);
